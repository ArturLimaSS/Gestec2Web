                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={4}>
                    <TextField
                      ...
                      onChange={e =>
                        setSiteData({ ...siteData, nome_site: e.target.value })
                      }
                      InputLabelProps={{
                        shrink:
                          !!siteData.nome_site || focusedField === "nome_site",
                      }}
                  ...
                  <Grid item xs={12} sm={4}>
                    <FormControl fullWidth margin="normal">
                      <InputLabel id="tipo_acesso_label">
                        Tipo de Acesso
                      </InputLabel>
                      <Select
                  ...
                  <Grid item xs={12} sm={4}>
                    <FormControl fullWidth margin="normal">
                      <InputLabel id="tipo_chave_label">
                        Tipo de Chave
                      </InputLabel>
                      <Select
                        label="Tipo de Chave"
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={4}>
                    <TextField
                      ...
                      InputLabelProps={{
                        shrink:
                          !!siteData.endereco_rua ||
                          focusedField === "endereco_rua",
                      }}
                  ...
                  <Grid item xs={12} sm={4}>
                    <TextField
                      ...
                      InputLabelProps={{
                        shrink:
                          !!siteData.endereco_numero ||
                          focusedField === "endereco_numero",
                      }}
                  ...
                  <Grid item xs={12} sm={4}>
                    <TextField
                      ...
                      InputLabelProps={{
                        shrink:
                          !!siteData.endereco_cidade ||
                          focusedField === "endereco_cidade",
                      }}
                  ...
                  <Grid item xs={12} sm={4}>
                    <FormControl fullWidth margin="normal">
                      ...
                      <Select
                        ...
                        InputLabelProps={{
                          shrink:
                            !!siteData.endereco_estado ||
                            focusedField === "endereco_estado",
                        }}
                  ...
                  <Grid item xs={12} sm={4}>
                    <TextField
                      ...
                      InputLabelProps={{
                        shrink:
                          !!siteData.endereco_cep ||
                          focusedField === "endereco_cep",
                      }}
            ...
            <BlankCard>
              <CardContent>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12} sm={4}>
                    <FormControl fullWidth margin="normal">
                      <InputLabel id="nivel_prioridade_label">
                        Prioridade
                      </InputLabel>
                      <Select
                        label="Prioridade"
